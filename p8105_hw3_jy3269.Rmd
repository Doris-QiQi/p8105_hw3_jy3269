...
length(unique(ny_noaa$id))       # number of missing values

no_missing = na.omit(ny_noaa)    # data removed of the NAs
nrow(no_missing)                 # number of rows without missing values
(nrow(ny_noaa)-nrow(no_missing))/nrow(ny_noaa)*100   # missing proportion
...
*  The missing value proportion of the 5 key variables are shown in the table.
